<?php require_once('includes/header.php');?>
    ...
    <!-- Carousel -->
    <section>
        <div id="carouselExampleCaptions" class="carousel slide carousel-home" data-bs-ride="false">
            ...
            <div class="bg-image-mask">
                <div class="container">
                    <div class="bg-image-text">
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. <br> Nunc donec est at rhoncus.</p>
                    </div>
                </div>
            </div>
        </div>
