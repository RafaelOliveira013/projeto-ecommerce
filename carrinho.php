        ...
        <section>
            <div class="container">
                ...
                <table class="table table-carrinho">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><i class="bi bi-x-circle-fill me-2"></i> <img src="/img/img-iphone-2.png" alt="Imagem de celular" width="40px"></th>
                    ...
                    <div class="col-md-6 offset-md-6">
                        ...
                        <div class="bg-white total-carrinho">
                            ...
                            <div class="row my-5">
                                ...
                                <p class="col-8"> 
                                    Envio grátis <br> As opções de envio serão actualizadas <br> durante a finalização da compra. <br> <a href="#">Calcular custos de envio</a>
                                </p>
                            </div>
                        ...
                        <div class="d-flex mt-3 mb-5">
                            <a href="recebido.php" class="btn-card text-center w-100 py-3">Finalizar compra <i class="bi bi-arrow-right ms-2 text-dark"></i></a>
                        </div>
                    </div>
                </div>
            </div>
