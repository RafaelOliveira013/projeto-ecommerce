        ...
        <div class="container mb-5 pt-4">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-primary" aria-current="page"><a href="loja.php">Loja</a></li>
            ...
            <div class="container">
                ...
                <div class="row categoria-descricao gap-4 mt-5 mt-md-4">
                    ...
                    <div class="col-6">
                        <h3>Descrição</h3>
                        <p class="mb-3">
                            Ecrã diagonal: 15,5 cm (6.1″), 2532×1170 pixels, OLED. Modelo de processador: <br> A14. Armazenamento interno: 64 GB. Câmara traseira: 12MP, dupla. SO instalado: <br> iOS 14. Iva incluído.
                            </p>
                    </div>
                </div>
            </div>
